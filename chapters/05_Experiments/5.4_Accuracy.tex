...
\begin{figure}[!tbp]
    \centering
    \subfloat[Warehouse environment]{\includegraphics[height=0.22\textheight]{warehousePR.pdf}\label{fig:prCurvesWarehouse}}
    \hfill
    \subfloat[House environment]{\includegraphics[height=0.22\textheight]{housePR.pdf}\label{fig:prCurveshouse}}
    \\
    \subfloat[Hospital environment]{\includegraphics[height=0.30\textheight]{hospitalPR.pdf}\label{fig:prCurvesHospital}}
